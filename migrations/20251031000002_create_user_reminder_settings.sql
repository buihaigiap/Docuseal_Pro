...
CREATE TABLE IF NOT EXISTS user_reminder_settings (
    ...
    fourth_reminder_hours INTEGER,  -- NULL by default, user must set to enable reminders
    fifth_reminder_hours INTEGER,  -- NULL by default, user must set to enable reminders
...
COMMENT ON COLUMN user_reminder_settings.fourth_reminder_hours IS 'Minutes after creation to send fourth reminder (NULL = not configured)';
COMMENT ON COLUMN user_reminder_settings.fifth_reminder_hours IS 'Minutes after creation to send fifth reminder (NULL = not configured)';
